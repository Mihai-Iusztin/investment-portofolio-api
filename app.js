...
var instrumentsDBRouter = require("./routes/instruments-db");
var instrumentsRouter = require("./routes/instruments-json");
...
app.use("/instruments-json", processingSimulate, instrumentsRouter);
